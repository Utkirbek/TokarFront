const uz = {
  ...
  perms: {
    permsAll: "Barcha ruxsatlar",
    accView: "Akkauntlarni ko'rish",
    prodOrgPrice: "Mahsulotning asl narxi",
    prodDel: "Mahsulotlarni o'chirish",
    settView: "Sozlamalarni ko'rish",
    prodView: "Mahsulotlarni ko'rish",
    adminsView: "Adminlarni ko'rish",
    statView: "Statistikani ko'rish",
    userView: "Foydalanuvchilarni ko'rish",
    userAdd: "Foydalanuvchi qo'shish",
    userEdit: "Foydalanuvchini tahrirlash",
    userDelete: "Foydalanuvchini o'chirish",
    userCreate: "Foydalanuvchi yaratish",
    statCost: "Statistikadagi narxlar",
    permRead: "Ruxsatlarni o'qish",
    prodEdit: "Mahsulotlarni tahrirlash",
    prodCreate: "Mahsulotlarni yaratish",
    read: "O'qish",
    permAdd: "Ruxsat qo'shish",
    permDelete: "Ruxsatlarni o'chirish",
    permUpdate: "Ruxsatlarni tahrirlash",
    adminsRead: "Adminlarni o'qish",
  },
};
